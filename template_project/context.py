...
class Context:
    ...
    Attributes
    ----------
    registry : dict[str, ContextVar]
        Context variables created so far, one per key.
    """
    ...
    def _get_context_var(self, key: str, default: Any = None) -> ContextVar:
        ...
        ----------
        key : str
            Registry key, taken from :class:`ContextKeys`.
        default : Any, optional
            Value the variable reports when nothing was set.

        Returns
        -------
        ContextVar
            The variable registered under ``key``.
        """
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        key : str
            Registry key, taken from :class:`ContextKeys`.
        default : Any, optional
            Value returned when nothing is bound.
